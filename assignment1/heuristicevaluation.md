...
### Yoga for Beginners
Yoga for Beginners is one of the top apps for yoga on the iOS app store and says to be "voice guided yoga right in your pocket. Yoga is a great way to relax and melt the stress away." The app is free on the iOS app store and does not require registration with an email. I decide to check it out by performing to tasks. The first was to choose from their selection of prepared yoga workout videos and do it. The second was to use their *create your own workout* option and choose my own series of poses. 

For both options you start on the first page and then get to choose from their current exercises and use filters depending on your level of expertise. You can then select one of their prepared sessions and click on it. At that point you will lend on the introduction page for that course where you will learn what poses to expect. You can then click on play and it will bring you to the actual video. This option is seamless and was something I was hoping to recreate in my project as well. For the customizable, you need to click on the option in the bottom center of the screen and then land on a new pagge when you can set up your own workout in 4 easy steps.

The overall design and navigation of the app felt very intuitive and enticing. However, I started to see some cracks in the user experience when I felt I couldn't choose the workouts based on my needs for specific strengthening of muscles ets. I then looked further and found a very confusing settings menu with no FAQ and very little help if lost. That is when I decided to take a closer look in a heuristic way at this website to see what could be learn from the errors in this app. 
